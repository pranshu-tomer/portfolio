...
export default function Form() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className='max-w-md w-full flex flex-col items-center justify-center space-y-4'>
      <input type="text" placeholder="Name" {...register("Name", {required: 'Name is required !!',minLength: {value: 3,message:'Name atleast have 3 character'}})} 
      ...
      <textarea {...register("message", {required: 'Message is required !!', maxLength:{value: 500,message:'Message should be short'}, minLength:{value: 10,message:'Message atleast have 10 characters'}})} 
      ...
      <input value='cast your message' className='px-8 py-2 text-accent rounded-md shadow-lg font-witch text-2xl border border-accent/30 border-solid hover:shadow-glass-sm backdrop-blur-sm text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 cursor-pointer capitalize' type="submit" />
    </form>
    </>
  );
}